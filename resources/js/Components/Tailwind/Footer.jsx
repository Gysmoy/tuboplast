...
const Footer = () => {
  const catalogLink = (segment) => `/catalog?segment%5B%5D=${encodeURIComponent(segment)}`;
      ...
      <div className="mx-auto grid w-full max-w-site gap-10 px-4 py-12 md:gap-12 md:py-16 lg:grid-cols-[minmax(0,1fr)_minmax(0,3fr)] lg:gap-16">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-10 sm:gap-x-10 md:grid-cols-4 lg:gap-x-12">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3 text-xs text-muted">
              <a href="/about" className="block transition hover:text-primary">Nosotros</a>
              <a href="/distributors" className="block transition hover:text-primary">Distribuidores</a>
              <a href="/club" className="block transition hover:text-primary">Club experto</a>
              <a href="/blog" className="block transition hover:text-primary">Blog</a>
            </div>
          </div>
          ...
          <div className="col-span-2 space-y-3 md:col-span-1">
            ...
            <div className="space-y-3 text-xs leading-relaxed text-muted">
              ...
              <p className="flex items-start gap-1.5">
                ...
                Calle Maria Curie 313, Ate, Lima
              </p>
            </div>
          </div>
